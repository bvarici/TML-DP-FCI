...
Most of the following code is imported from https://github.com/jc1850/Learning-Causal-Networks-in-Python
...
class PAG(nx.DiGraph):
    ...
    def add_edge(self, u,v, utag = 'o', vtag = 'o'):
        ...
        # BV update
        #super().add_edges_from([(v,u, {v:vtag, u:utag})])
    ...
    def add_edges_from(self, bunch):
        ...
        """
        for edge in bunch:
            super().add_edges_from([(*(edge[0],edge[1]), {edge[0]:'o', edge[1]:'o'})])
            # BV update
            super().add_edges_from([(*(edge[1],edge[0]), {edge[1]:'o', edge[0]:'o'})])
    ...
    def direct_edge(self, u,v):
        ...
        if super().has_edge(u,v):
            self.edges[(u,v)][v] = '>'
            # BV update. also assign (v,u), ordered
            self.edges[(v,u)][v] = '>'
